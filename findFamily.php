...
$family = find_all_families($first_name, $last_name, $email, $neighborhood, $address, $city, $zip, $income, $assistance, $phone, $language, $is_archived);
...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    if (isset($args['assistance']) && $args['assistance'] !== "") {
...
<form id="formatted_form" method="POST">
    ...
    <div class="search-container">
        <div class="search-label"><label>Email:</label></div>
    ...
    <div class="search-container">
        <div class="search-label"><label>Zip:</label></div>
        <div><input type="number" id="zip" name="zip"></div>
    </div>
    <div class="search-container">
        <div class="search-label"><label>Current Assistance:</label></div>
        <div><input type="text" id="assistance" name="assistance"></div>
    </div>
    <div class="search-container">
    ...
    <div class="search-container">
        <div class="search-label"><label>Phone Number:</label></div>
        <div><input type="text" id="phone" name="phone"></div>
    </div>
    <!-- <div class="search-container">
        <div class="search-label"><label>Preferred Language:</label></div>
        <div><input type="text" id="language" name="language"></div>
    </div> -->
    <div class="search-container">
        <div class="search-label"><label>Archived:</label></div>
        <div><input type="checkbox" id="is-archived" name="is-archived" value="1"></div>
    </div>
    ...
    if (isset($family)) {
        ...
        echo '<div class="table-wrapper"><table class="general"><thead><tr>
